    ...
    return (
        <div class="drawer drawer-end">
            ...
            <div class="drawer-content flex flex-col">
                <div class="w-full navbar bg-base-100 fixed top-0 z-50 px-16">
                    <div class="flex-1 px-2 mx-2"><Link to='/'>Clean & Co.</Link></div>
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-3">
                            ...
                            <li><NavLink className='rounded-lg' to='/upwork'>Upwork</NavLink></li>
                            <li>
            ...
            <div class="drawer-side">
                ...
                <ul class="menu p-4 overflow-y-auto w-80 bg-base-100 gap-y-3">
                    ...
                    <li class="dropdown dropdown-hover dropdown-end">
                        <label tabindex="0" class="btn  btn-outline rounded-lg">Book now</label>
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li><a>Item 1</a></li>
                            <li><a>Item 2</a></li>
                        </ul>
